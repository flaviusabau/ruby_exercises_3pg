...
RSpec.describe 'Hash Exercises' do
  ...
  describe 'create favorite hash exercise' do
    it 'returns result with a string and integer' do
      favorite = create_favorite_hash(a,b)
      result = { color: a, number: b }
  ...
  describe 'update favorite movie exercise' do
    ...
    it 'returns hash with a new key/value pair when not included' do
      ...
      my_result = update_favorite_movie(my_favorites,'Avengers: Endgame')
      expect(my_result).to eq(result)
    end
